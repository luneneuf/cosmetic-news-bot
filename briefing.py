...
같은 사건·발표·기업 동향을 다룬 기사가 여러 개 있으면 가장 정보가 풍부한 1건만 선정하고 나머지는 반드시 제외하라.
제목이 달라도 핵심 주어(기업명)와 사건(시장 진출, 신제품 출시, 계약 체결 등)이 같으면 동일 기사로 간주한다.
예: "A사 미국 오프라인 입점"과 "A사 북미 매장 공략"은 같은 사건이므로 1건만 포함.
