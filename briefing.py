...
같은 사건·발표·기업 동향·행사를 다룬 기사가 여러 개 있으면 가장 정보가 풍부한 1건만 선정하고 나머지는 반드시 제외하라.
제목이 달라도 아래 중 하나에 해당하면 동일 기사로 간주한다:
- 핵심 주어(기업명·인물명)와 사건(시장 진출, 신제품 출시, 계약 체결 등)이 같은 경우
- 같은 포럼·컨퍼런스·간담회·행사에서 나온 발언·보도인 경우 (발언자가 달라도 동일 행사면 1건)
- 제목이 지나치게 짧거나 단편적이어서 정보량이 현저히 적은 경우 (더 상세한 기사로 대체)
예1: "A사 미국 오프라인 입점"과 "A사 북미 매장 공략" → 1건
예2: "K뷰티 포럼 데이터·소재 핵심"과 "구윤철 K뷰티 미래전략산업"과 "구윤철 R&D 경쟁력" → 동일 행사 보도, 1건
